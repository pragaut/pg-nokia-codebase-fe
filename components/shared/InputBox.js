...
class InputBox extends Component {
    render() {
        return (
            <InputWapper focusbordercolor={this.props.focusbordercolor} wapperMargin={this.props.wapperMargin} inputPadding={this.props.inputPadding} wapperWidth={this.props.wapperWidth}>
